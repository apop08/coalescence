...
namespace Scuttlemeyer
{
	...
	class ObjectAllocator
	{
	  ...
	  private:
		...
		void AllocateNewPage() throw(OAException);
		void Alignment();
		void check_padbytes() throw(OAException);
		void validate_object() throw(OAException);
		bool check_empty_page(unsigned char *);
		void fix_free_list(unsigned char *);

		//Debug check on DumpMemory in use and FreeEmptyPages
