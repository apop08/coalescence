...
AppId={{F4FB8DFD-EE7C-4A83-A03B-FBADC21B0D51}}
; Standard app data stuff
; Change GameTestInstall to your game name
AppName=Coalescence
AppVerName=Coalescence Version 1.0
...
DefaultDirName={pf}\DigiPen\Coalescence
; Start menu directory
DefaultGroupName=DigiPen\Coalescence
; Output directory for the installer.
OutputDir=.\INSTALLER
; Setup executable installer
OutputBaseFilename=Coalescence_Setup
...
SetupIconFile=.\Files\autocad.ico
...
[Icons]
Name: {group}\Coalescence; Filename: {app}\Game\Coalescence.exe; WorkingDir: {app}
Name: {group}\{cm:UninstallProgram,Coalescence}; Filename: {uninstallexe}
Name: {commondesktop}\Coalescence; Filename: {app}\Game\Coalescence.exe; Tasks: desktopicon; WorkingDir: {app}
...
Filename: {app}\Game\Coalescence.exe; Description: {cm:LaunchProgram,Coalescence}; Flags: nowait postinstall skipifsilent